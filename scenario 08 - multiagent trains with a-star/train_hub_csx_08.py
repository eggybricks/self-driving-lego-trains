...
# Color.GRAY = Color(h=0, s=30, v=3)Color.BLUE = Color(h=216, s=79, v=5)
# on ground later
Color.BLUE = Color(h=240, s=75, v=5)
Color.GREEN = Color(h=110, s=55, v=3)
Color.YELLOW = Color(h=48, s=95, v=9)
Color.RED = Color(h=352, s=90, v=5)
