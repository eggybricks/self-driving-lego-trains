...
while True:
    ...
    # Toggle position
    switch_states["SWITCH_H"] = (
        SWITCH_POSITION["DIVERGING"] if switch_states["SWITCH_H"] == SWITCH_POSITION["STRAIGHT"]
        else SWITCH_POSITION["STRAIGHT"]
    )
    move_switch("SWITCH_H", switch_states["SWITCH_H"])
    wait(500)
    switch_states["SWITCH_I"] = (
        SWITCH_POSITION["DIVERGING"] if switch_states["SWITCH_I"] == SWITCH_POSITION["STRAIGHT"]
        else SWITCH_POSITION["STRAIGHT"]
    )
    move_switch("SWITCH_I", switch_states["SWITCH_I"])
